...
<form action="../productDlServlet?method=addProductDl" method="post">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td class="tableleft">分类名称</td>
        <td><input type="text" name="categoryName" id="cateName" value=""/></td>
    </tr>   
    <tr>
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="productDlServlet?method=getProductDl";
		 });
