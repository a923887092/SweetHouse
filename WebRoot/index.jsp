<!DOCTYPE HTML>
<%@page import="com.gwm.sweethouse.bean.AdminUser"%>
<html>
<head>
    <title>后台管理系统</title>
...
<div class="header">
    ...
    </span><a href="/chinapost/index.php?m=Public&a=logout" title="退出系统" class="dl-log-quit">[退出]</a>
    </div>
</div>
<div class="content">
