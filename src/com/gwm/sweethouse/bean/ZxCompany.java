...
public class ZxCompany {
	...
	public ZxCompany(int zx_comid, String zx_comName, String zx_comlog,
			String zx_comaprice, String zx_comexample, String zx_comdesigner,
			String zx_comaddr, String zx_comstyle) {
		super();
		this.zx_comid = zx_comid;
		this.zx_comName = zx_comName;
		this.zx_comlog = zx_comlog;
